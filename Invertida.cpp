...
struct Vertice{
	...
	Vertice(string nom, double m[2][2],double p[2]){
	nombre=nom;
	sig=NULL;
	ari=NULL;
	for(int i=0; i<2;i++){
...
void Grafo::InsertarVertice(string nom, double ma[2][2],double p[2]){
	if(ObtenerVertice(nom)==NULL){
		Vertice* nuevo = new Vertice(nom,ma,p);
		if(EstaVacio()){
			primero=nuevo;
		}
		else{
...
void Grafo::Pi(Vertice* v){
	...
	if(t==2){
		v->pi[0]=h[0]->pi[0]*h[1]->pi[0]*h[0]->pro[0][0]+
						 h[0]->pi[0]*h[1]->pi[1]*h[0]->pro[0][1]+
						 h[0]->pi[1]*h[1]->pi[0]*h[1]->pro[0][0]+
						 h[0]->pi[1]*h[1]->pi[1]*h[1]->pro[0][1];
		v->pi[1]=h[0]->pi[0]*h[1]->pi[0]*h[0]->pro[1][0]+
						 h[0]->pi[0]*h[1]->pi[1]*h[0]->pro[1][1]+
						 h[0]->pi[1]*h[1]->pi[0]*h[1]->pro[1][0]+
						 h[0]->pi[1]*h[1]->pi[1]*h[1]->pro[1][1];
	}
	if(t==3){
		v->pi[0]=h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
						 h[0]->pro[0][0]+
             h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[1]*
						 h[0]->pro[0][1]+
						 h[0]->pi[0]*h[1]->pi[1]*h[2]->pi[0]*
						 h[1]->pro[0][0]+
             h[0]->pi[0]*h[1]->pi[1]*h[2]->pi[1]*
						 h[1]->pro[0][1]+
						 h[0]->pi[1]*h[1]->pi[1]*h[2]->pi[0]*
						 h[2]->pro[0][0]+
             h[0]->pi[1]*h[1]->pi[1]*h[2]->pi[1]*
						 h[2]->pro[0][1];

		v->pi[1]=h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
						 h[0]->pro[1][0]+
             h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[1]*
						 h[0]->pro[1][1]+
						 h[0]->pi[0]*h[1]->pi[1]*h[2]->pi[0]*
	...
	if(t==4){
		v->pi[0]=h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[0]->pro[0][0]+
						 h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[1]*h[0]->pro[0][1]+
						 h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[1]->pro[0][0]+
						 h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[1]*
			       h[3]->pi[1]*h[1]->pro[0][1]+
             h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[2]->pro[0][0]+
						 h[0]->pi[0]*h[1]->pi[1]*h[2]->pi[1]*
			       h[3]->pi[1]*h[2]->pro[0][1]+
						 h[0]->pi[1]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[3]->pro[0][0]+
						 h[0]->pi[1]*h[1]->pi[1]*h[2]->pi[1]*
			       h[3]->pi[1]*h[3]->pro[0][1];

		v->pi[1]=h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[0]->pro[1][0]+
						 h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[1]*h[0]->pro[1][1]+
						 h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[1]->pro[1][0]+
						 h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[1]*
			       h[3]->pi[1]*h[1]->pro[1][1]+
             h[0]->pi[0]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[2]->pro[1][0]+
						 h[0]->pi[0]*h[1]->pi[1]*h[2]->pi[1]*
			       h[3]->pi[1]*h[2]->pro[1][1]+
						 h[0]->pi[1]*h[1]->pi[0]*h[2]->pi[0]*
			       h[3]->pi[0]*h[3]->pro[1][0]+
						 h[0]->pi[1]*h[1]->pi[1]*h[2]->pi[1]*
			       h[3]->pi[1]*h[3]->pro[1][1];
...
void Grafo::PropagacionPi(){
	...
	Vertice* padre=Padres(hojas[0]);
	cout<<padre->nombre<<endl;
	for(int i=0; i<hojas.size();i++){
		hojas[i]->pi[0]=hojas[i]->mp[0];
		hojas[i]->pi[1]=hojas[i]->mp[1];
	}
	if(padre==primero){
		Pi(padre);
	}
	else{
	vector<Vertice*> hermanos=Hermanos(padre);
	while(padre != primero){
		Pi(padre);
		cout<<padre->nombre<<endl;
		hermanos=Hermanos(padre);
		for(int i=0; i<hermanos.size();i++){
			Pi(hermanos[i]);
		}
		padre=Padres(padre);
	}
	padre=hojas[hojas.size()-1];
	while(padre != primero){
		Pi(padre);
		cout<<padre->nombre<<endl;
		hermanos=Hermanos(padre);
